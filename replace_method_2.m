function community = replace_method_2(community, community_fitness, pick_function, crossover_function, mutation_probability, mutation_function, ages_to_train, crossover_probability, layerSizes, values, error, parents_size)
	children = {};
